...
const BrowseArtistMerch = () => {
  const [activeIndex, setActiveIndex] = useState(0);
  return (
    <section className="w-full bg-white">
      <section className="container mx-auto lg:px-10 pt-[30px]">
        <SectionHeading textOne="Browse Artists" textTwo="Merch" />
...
export default BrowseArtistMerch;
