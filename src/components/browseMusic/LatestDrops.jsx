...
const LatestDrops = () => {
  ...
  return (
    <section className="w-full bg-white">
      <section className="container mx-auto lg:px-10 pb-[60px] pt-[110px] lg:pt-[120px]">
        <SectionHeading textOne="Latest" textTwo="DROPS" />
    ...
    <div className="w-full md:w-[200px] flex flex-col">
      ...
      <div className="bg-[#EDEDED] rounded-bl-[10px] rounded-br-[10px] px-[5px] py-[10px] flex items-center gap-[7px]">
        ...
        <div>
          ...
          <p className="my-[5px] text-[#000] text-[10px] font-">
