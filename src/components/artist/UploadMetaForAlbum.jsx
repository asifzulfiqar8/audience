...
import MetadataFormForAlbum from "./MetadataFormForAlbum";

const UploadMetaForAlbum = () => {
  return (
    <div className="w-full">
      ...
      <div className="lg:mt-[40px]">
        <GradientHeading
          ...
          linearGradient="linear-gradient(186.81deg, #FF0000 29.27%, #00071D 98.49%)"
        />
      </div>
      ...
      <p className="mt-5 md:mt-7 text-xl font-bold font-noka text-textColor">
        <span>Enter Optional Information</span>
      </p>
      {/* metadata form */}
      <MetadataFormForAlbum />
    </div>
  );
};

export default UploadMetaForAlbum;
